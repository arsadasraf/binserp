 ...
 */
export const sendEmailOTP = async (toEmail: string, otp: string, subject = "Your Binserp Verification Code") => {
  const htmlContent = `
 ...
 */
export const getWhatsAppDeepLink = (phoneNumber: string, otp: string): string => {
