...
import employeeMovementRoutes from "./routes/employeeMovement.routes.js";
...
app.use("/saasadmin", saasAdminRoutes);
app.use("/api/visitor", visitorRoutes);
app.use("/api/vehicle", vehicleRoutes);
app.use("/api/employee-movement", employeeMovementRoutes);
