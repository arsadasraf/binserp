...
import { 
  ...
  Package, Boxes, Wrench as ToolIcon, Eye
} from 'lucide-react';
  ...
  return (
    <div className="space-y-2.5 font-sans">
      ...
      {context === 'store' ? (
        ...
        <div className="bg-white p-1.5 rounded-xl border border-slate-200/90 shadow-2xs flex flex-wrap items-center justify-between gap-1.5">
          ...
          <button
            ...
            disabled={loading}
            className="ml-auto px-3 py-1.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 rounded-lg text-xs font-semibold flex items-center gap-1.5 cursor-pointer transition-all shadow-2xs shrink-0"
      ...
      {/* 2. Unified Filter Toolbar: Search, Supplier, Date/Month, Status, Defect */}
        ...
        <div className="flex flex-wrap items-center gap-2 flex-1 min-w-[280px]">
          ...
          <div className="relative flex-1 min-w-[170px] max-w-xs">
            ...
            <input
              ...
              className="w-full pl-7 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-lg outline-none text-slate-800 focus:bg-white focus:border-blue-500"
            />
          </div>
      ...
      <AnimatePresence>
        {selectedTicket && (
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-2xs z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
            <motion.div
              initial={{ opacity: 0, scale: 0.96 }}
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.96 }}
              className="bg-white w-full max-w-2xl rounded-xl shadow-xl border border-slate-200 overflow-hidden my-auto"
            >
              ...
              <form onSubmit={handleSubmitAction} className="p-4 space-y-3.5 text-xs">
                <div>
        ...
        {editTicket && (
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-2xs z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.96 }}
              className="bg-white w-full max-w-xl rounded-xl shadow-xl border border-slate-200 overflow-hidden my-auto"
            >
              <div className="p-4 bg-amber-50 border-b border-amber-200 text-amber-900 flex justify-between items-center">
                <div>
              ...
              <form onSubmit={handleSubmitEditAction} className="p-4 space-y-3.5 text-xs">
                <div>
        ...
        {reworkModalTicket && (
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-2xs z-50 flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.96 }}
              className="bg-white w-full max-w-lg rounded-xl shadow-xl border border-slate-200 overflow-hidden my-auto"
            >
              <div className="p-4 bg-slate-50 border-b border-slate-200 flex justify-between items-center">
