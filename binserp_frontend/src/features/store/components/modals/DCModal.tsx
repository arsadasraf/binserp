                    ...
                    <div className="space-y-4">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                {index === items.length - 1 && (
                                                    <button
                                                        type="button"
                                                        onClick={addItem}
                                                        className="px-2.5 py-1 text-xs font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/40 hover:bg-blue-100 dark:hover:bg-blue-900/70 border border-blue-200 dark:border-blue-800 rounded-xl flex items-center gap-1 transition-all shadow-2xs cursor-pointer"
                        ...
                        <div className="pt-2">
                            ...
                            >
                                ...
                                <span>+ Add Another {materialTypeLabelMap[dcMaterialType] || 'Line'} Item</span>
                            </button>
                        </div>
                    </div>
