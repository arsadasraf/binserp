                                            ...
                                            <tr key={index} className="hover:bg-indigo-50/20 transition-colors">
                                                ...
                                                <td className="py-2 px-3">
                                                    <input
                                                        ...
                                                        placeholder="0"
                                                        className="w-full px-2 py-1.5 bg-white border border-gray-300 rounded-lg text-xs font-bold text-gray-900 focus:ring-2 focus:ring-indigo-500"
                                                    />
                                                </td>
                                                ...
                                                <td className="py-2 px-3">
                                                    <input
                                                        ...
                                                        className="w-full px-2 py-1.5 bg-gray-50 border border-gray-300 rounded-lg text-xs font-bold text-gray-700 text-center"
                                                    />
                                                </td>
                                                ...
                                                <td className="py-2 px-3">
                                                    <input
                                                        ...
                                                        placeholder="0.00"
                                                        className="w-full px-2 py-1.5 bg-white border border-gray-300 rounded-lg text-xs font-semibold text-gray-800 focus:ring-2 focus:ring-indigo-500"
                                                    />
                                                </td>
                                                ...
                                                <td className="py-2 px-3">
                                                    <select
                                                        ...
                                                        className="w-full px-2 py-1.5 bg-white border border-gray-300 rounded-lg text-xs font-semibold focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                                                    >
