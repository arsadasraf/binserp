...
export const SalesOrderDetailsModal: React.FC<SalesOrderDetailsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-3 sm:p-4 bg-gray-900/60 backdrop-blur-sm overflow-y-auto">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col my-auto max-h-[92vh] border border-gray-100 dark:border-gray-800">
