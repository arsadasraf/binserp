...
const storeEndpoints = [
  ...
  { key: "raw-material", url: "/api/store/raw-material", tag: "StoreInventory", dataKey: "rawMaterials" },
  { key: "raw-materials", url: "/api/store/raw-material", tag: "StoreInventory", dataKey: "rawMaterials" },
  { key: "bought-out", url: "/api/store/bought-out", tag: "StoreInventory", dataKey: "boughtOuts" },
  ...
  { key: "consumables", url: "/api/store/consumables", tag: "StoreInventory", dataKey: "consumableItems" },
  ...
  { key: "billing", url: "/api/sales/invoice", tag: "StoreInvoice", dataKey: "invoices" },
  ...
  { key: "order-entry", url: "/api/sales/order", tag: "StoreOrder", dataKey: "orders" },
  ...
  endpoints: (builder) => ({
    getStoreData: builder.query<any, StoreTab>({
      ...
      transformResponse: (response: any, _meta, tab) => {
        ...
        if (!current) return [];
        if (tab === "company-info") {
          return response?.bankDetails ? response : (response?.companyInfo || response?.data || response);
        }
