...
export const MASTER_EXCEL_CONFIGS: Record<string, { title: string; filename: string; columns: MasterColumnConfig[] }> = {
    'raw-material': {
        ...
        columns: [
            ...
            { label: 'Secondary Unit Applicable (Yes/No)', key: 'hasSecondaryUnit', sample: 'No' },
            { label: 'Secondary Unit', key: 'secondaryUnit', sample: 'Kg' },
            { label: 'Conversion Factor (1 Unit = ? Sec Unit)', key: 'conversionFactor', sample: 1 },
    ...
    'fg-items': {
        ...
        columns: [
            ...
            { label: 'Secondary Unit Applicable (Yes/No)', key: 'hasSecondaryUnit', sample: 'No' },
            { label: 'Secondary Unit', key: 'secondaryUnit', sample: 'Kg' },
            { label: 'Conversion Factor', key: 'conversionFactor', sample: 1 },
...
export const STORE_COLUMN_ALIASES: Record<string, string[]> = {
    ...
    'hasSecondaryUnit': ['secondary unit applicable', 'secondary unit applicable (yes/no)', 'has secondary unit', 'dual unit', '2nd unit applicable', 'secondary unit active'],
    'secondaryUnit': ['secondary unit', '2nd unit', 'second unit', 'alternate unit', 'alt unit'],
    'conversionFactor': ['conversion factor', 'conversion factor (1 unit = ? sec unit)', 'conversion ratio', 'unit conversion', 'factor', 'ratio'],
