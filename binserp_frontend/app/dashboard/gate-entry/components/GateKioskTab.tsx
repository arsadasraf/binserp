...
export default function GateKioskTab({ initialSubTab = 'manual' }: { initialSubTab?: 'manual' | 'kiosk' }) {
    const router = useRouter();
    const [subTab, setSubTab] = useState<'manual' | 'kiosk'>(initialSubTab);
        ...
        <div className="space-y-6 animate-in fade-in">
            ...
            <div className="flex space-x-2 border-b border-gray-200 dark:border-slate-700 pb-0">
                <button 
                    onClick={() => {
                        setSubTab('manual');
                        router.push('/dashboard/gate-entry/kiosk/manual');
                    }}
                ...
                <button 
                    onClick={() => {
                        setSubTab('kiosk');
                        router.push('/dashboard/gate-entry/kiosk/face');
                    }}
