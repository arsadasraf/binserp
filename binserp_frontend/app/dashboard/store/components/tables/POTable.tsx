...
import { Edit2, Trash2, Download, FileSpreadsheet, Eye, X, Printer, Building2, ShoppingCart, Search, Clock, User, ShieldCheck, History, Truck, Lock, Plus } from 'lucide-react';
...
export default function POTable({ data, vendors = [], companyInfo, onEdit, onDelete, onStatusChange, onCreatePO }: POTableProps) {
